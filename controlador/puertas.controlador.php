...
<?php
	...
	======================================*/
		...
		static public function ctrEstadisticas($tabla, $date)
		{
			
			$respuesta = puertaModelo::mdlEstadisticas($tabla,$date);

			return $respuesta;

		}
		//fin del metodo de mostrar estadisticas por rango de fechas
